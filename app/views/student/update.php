<div class="container">
    ...
    <div class="row justify-content-between">
        <div class="col-4">
            <div><h1>Update Student Record:</h1></div>
        </div>
        <div class="col-4">
            <div> <button class="btn btn-secondary" type="button" onclick="location.href='/controller=student&action=listdata'">Back</button></div>
        </div>
    </div>
    <br>
</div>
<div class="container">
    <form action="" method="post" >
        ...
        <button type="submit" class="btn btn-primary" onclick="location.href='/controller=student&action=listdata'">Cancel</button>
        <button type="submit" class="btn btn-primary" onclick="location.href='/controller=student&action=update'">Submit</button>
    </form>
</div>
