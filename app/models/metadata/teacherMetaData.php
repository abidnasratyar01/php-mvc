...
/**
 * This Class handles data about Teachers and acts as metadata descriptor for ORM which is used to connect the object 
 * code to Database by providing the queryBuidler necessary data about Teachers to build query which is at the end 
...
class teacherMetaData
{
    ...
    public function getId() 
    {
     ...
     /**
     * Public method that is responsible to return Table Name of Teachers in DB. It is called from the queryBuilder's methods for 
     * construction of querys.
     *
     * @return string
     */
